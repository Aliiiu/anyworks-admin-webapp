  ...
  return (
    <DashboardLayout pageTitle="Bookings" rhsHeading={<RhsHeading handleChange={handleChange} />}>
      <BookingsPageContainer>
        <BookingsTabs rows={filteredData} BookingsTableHeaders={BookingsTableHeaders} title={<div className="heading">
        <p className="count">{RECENT_BOOKINGS_TABLE_DATA().length} Bookings</p>
      </div>} onRowClick={() => navigate('/bookings/booking-details')}/>
      </BookingsPageContainer>
    </DashboardLayout>
  )
}
